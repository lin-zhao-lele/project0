...
def get_data(config):
    ...
    # 构造保存路径
    save_dir = os.path.join(os.path.dirname(os.path.dirname(BASE_DIR)), "data", "raw")
    os.makedirs(save_dir, exist_ok=True)  # 确保目录存在
    filename = os.path.join(save_dir, f"{stock_code}_{start_date}_{end_date}_{freq}_{field_type}.csv")
